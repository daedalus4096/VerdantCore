...
import com.verdantartifice.verdantcore.common.books.LinguisticsMode;
 ...
 * @author Daedalus4096
 */
public interface IPlayerLinguistics extends INBTSerializableVC<CompoundTag> {
     ...
     */
    @Nonnull
    LinguisticsMode getScribeTableMode();
     ...
     */
    void setScribeTableMode(@Nonnull LinguisticsMode mode);
