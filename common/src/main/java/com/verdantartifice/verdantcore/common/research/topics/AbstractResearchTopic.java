...
public abstract class AbstractResearchTopic<T extends AbstractResearchTopic<T>> {
    public static Codec<AbstractResearchTopic<?>> dispatchCodec() {
        return ServicesVC.RESEARCH_TOPIC_TYPES_REGISTRY.codec().dispatch("topic_type", AbstractResearchTopic::getType, ResearchTopicType::codec);
    }
    
    public static StreamCodec<RegistryFriendlyByteBuf, AbstractResearchTopic<?>> dispatchStreamCodec() {
        return ServicesVC.RESEARCH_TOPIC_TYPES_REGISTRY.registryFriendlyStreamCodec().dispatch(AbstractResearchTopic::getType, ResearchTopicType::streamCodec);
    }
