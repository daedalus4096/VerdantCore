...
public record BookDefinition(ResourceLocation bookId) {
    ...
    public static final Codec<Holder<BookDefinition>> HOLDER_CODEC = RegistryFixedCodec.create(RegistryKeysVC.BOOKS);
    public static final StreamCodec<RegistryFriendlyByteBuf, Holder<BookDefinition>> STREAM_CODEC = ByteBufCodecs.holderRegistry(RegistryKeysVC.BOOKS);
}
