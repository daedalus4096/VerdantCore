...
public record BookLanguage(ResourceLocation languageId, Style style, int complexity, boolean autoTranslate) {
    ...
    public static final Codec<Holder<BookLanguage>> HOLDER_CODEC = RegistryFixedCodec.create(RegistryKeysVC.BOOK_LANGUAGES);
    public static final StreamCodec<RegistryFriendlyByteBuf, Holder<BookLanguage>> STREAM_CODEC = ByteBufCodecs.holderRegistry(RegistryKeysVC.BOOK_LANGUAGES);
