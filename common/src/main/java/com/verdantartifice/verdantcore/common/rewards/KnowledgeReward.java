...
public class KnowledgeReward extends AbstractReward<KnowledgeReward> {
    ...
    @Override
    protected RewardType<KnowledgeReward> getType() {
        return RewardTypesVC.KNOWLEDGE.get();
    }
    ...
    public Component getDescription(Player player) {
        ...
        return Component.translatable("label.verdantcore.scribe_table.grid.reward.knowledge", typeText, amountText);
    }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof KnowledgeReward that)) return false;
        return levels == that.levels && Objects.equals(knowledgeType, that.knowledgeType);
    }

    @Override
    public int hashCode() {
        return Objects.hash(knowledgeType, levels);
    }
