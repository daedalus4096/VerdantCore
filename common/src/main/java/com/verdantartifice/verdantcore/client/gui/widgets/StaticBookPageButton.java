package com.verdantartifice.verdantcore.client.gui.widgets;

import com.verdantartifice.verdantcore.client.books.ClientBookHelper;
...
public class StaticBookPageButton extends PageButton {
    ...
    public StaticBookPageButton(int pX, int pY, boolean pIsForward, OnPress pOnPress, boolean pPlayTurnSound, BookType bookType) {
