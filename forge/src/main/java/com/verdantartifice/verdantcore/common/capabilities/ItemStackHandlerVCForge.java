 ...
 * @author Daedalus4096
 */
public class ItemStackHandlerVCForge extends ItemStackHandler implements IItemHandlerVC {
    ...
    public ItemStackHandlerVCForge(AbstractTileVC tile) {
        super();
        this.tile = tile;
    ...
    public ItemStackHandlerVCForge(int size, AbstractTileVC tile) {
        super(size);
        this.tile = tile;
        this.limitFuncOverride = Optional.empty();
        this.validityFuncOverride = Optional.empty();
    ...
    public ItemStackHandlerVCForge(NonNullList<ItemStack> stacks, AbstractTileVC tile) {
        super(stacks);
        this.tile = tile;
        this.limitFuncOverride = Optional.empty();
        this.validityFuncOverride = Optional.empty();
    ...
    public ItemStackHandlerVCForge(IItemHandler original, @Nullable AbstractTileVC tile) {
    ...
    protected ItemStackHandlerVCForge(NonNullList<ItemStack> stacks, AbstractTileVC tile, Optional<Function<Integer, Integer>> limit,
    ...
    public static class Builder implements IItemHandlerVC.Builder {
        ...
        public IItemHandlerVC build() {
            return new ItemStackHandlerVCForge(this.stacks, this.tile, this.limitFuncOverride,
